...
//     [MTest] public IEnumerator LoadSimpleHTML () {
//         var sampleHtml = @"
// <body>something</body>
//         ";
//         ParsedTree parsedRoot = null;
...
//     [MTest] public IEnumerator LoadDepthAssetListIsDone () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator LoadDepthAssetListWithCustomTag () {
//         var sampleHtml = @"
// <!DOCTYPE uuebview href='resources://Views/ParserTest/UUebTags'>
...
//     [MTest] public IEnumerator ParseSimpleHTML () {
//         var sampleHtml = @"
// <body>something</body>
//         ";
//         ParsedTree parsedRoot = null;
...
//     [MTest] public IEnumerator ParseCustomTag () {
//         var sampleHtml = @"
// <!DOCTYPE uuebview href='resources://Views/ParserTest/UUebTags'>
...
//     [MTest] public IEnumerator ParseCustomTagMoreDeep () {
//         var sampleHtml = @"
// <!DOCTYPE uuebview href='resources://Views/ParserTest/UUebTags'>
...
//     [MTest] public IEnumerator ParseCustomTagRecursive () {
//         var sampleHtml = @"
// <!DOCTYPE uuebview href='resources://Views/ParserTest/UUebTags'>
// <customtag><customtagpos><customtagtext>
...
//     [MTest] public IEnumerator ParseImageAsImgContent () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator ParseCustomImgAsImgContent () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator ParseCustomTextAsTextContent () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator ParserTestCustomLayerAndCustomContentCombination () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator Revert () {
//         var sampleHtml = @"
// <body>something</body>
//         ";
//         ParsedTree parsedRoot = null;
...
//     [MTest] public IEnumerator ParseDefaultTag () {
//         var sampleHtml = @"
// <body>something</body>
//         ";
//         ParsedTree parsedRoot = null;
...
//     [MTest] public IEnumerator WithCustomTag () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator WithWrongCustomTag () {
//         var sampleHtml = @"
// <!DOCTYPE uuebview href='resources://Views/WithCustomTag/UUebTags'>
...
//     [MTest] public IEnumerator WithDeepCustomTag () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator WithDeepCustomTagBoxHasBoxAttr () {
//         var sampleHtml = @"
// <!DOCTYPE uuebview href='resources://Views/WithDeepCustomTag/UUebTags'>
// <customtag><img src='https://github.com/sassembla/Autoya/blob/master/doc/scr.png?raw=true2' /><img src='https://github.com/sassembla/Autoya/blob/master/doc/scr.png?raw=true2' /></customtag>
// <p>else</p>
...
//     [MTest] public IEnumerator ParseErrorAtDirectContentUnderLayer () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator CoronWrappedContentSupport () {
//         var sampleHtml = @"
// <p>
...
//     [MTest] public IEnumerator CustomEmptyLayerCanSingleCloseTag () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator CustomEmptyLayerCanSingleCloseTag2 () {
//         var sampleHtml = @"
// <!DOCTYPE uuebview href='resources://Views/MyInfoView/UUebTags'>
...
//     [MTest] public IEnumerator AlignSupport () {
//         var sampleHtml = @"
...
//     [MTest] public IEnumerator SinglePSupport () {
//         var sampleHtml = @"
// <body>bbb<p>aaa</body>";
//         ParsedTree parsedRoot = null;
//         yield return GetParsedRoot(sampleHtml, parsedRootSource => {parsedRoot = parsedRootSource;});
