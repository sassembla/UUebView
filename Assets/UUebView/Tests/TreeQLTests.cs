...
<body>something1.<img src='https://dummyimage.com/100.png/09f/fff'/></body>";
    ...
    [MTest]
    public IEnumerator AppendContent()
    {
        var source = @"
<body>something1.<img src='https://dummyimage.com/100.png/09f/fff'/></body>";
    ...
    [MTest]
    public IEnumerator AppendContentToContent()
    {
        var source = @"
<body>something1.<img src='https://dummyimage.com/100.png/09f/fff'/></body>";
...
<body>something1.<img src='https://dummyimage.com/100.png/09f/fff'/></body>";
    ...
    [MTest]
    public IEnumerator DeleteContentOfBody()
    {
        var source = @"
<body>something1.<img src='https://dummyimage.com/100.png/09f/fff'/></body>";
    ...
    [MTest]
    public IEnumerator GetNewContentIds()
    {
        var source = @"
<h1 id='test'>Miyamasu Runtime Console</h1>";
    ...
    [MTest]
    public IEnumerator AddNewContentIds()
    {
        var source = @"
